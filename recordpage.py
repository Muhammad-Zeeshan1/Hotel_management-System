...
def submit():
    with open("record.txt", "a") as f:
        f.write(f"Username = {nameValue.get()}, Email = {emailValue.get()}, Phone number = {phoneValue.get()}, agreement = {agreementValue.get()}\n")
...
Label (root, text="Kindly fill the following details:-", font="lucida 20 bold", pady=30, bg="RED" ).grid(row=0, column=4)

Label(root, text="First name\t \t -", font="lucida 15 bold", padx=1).grid(row=1, column=3)
Label(root, text="Surname name\t \t -", font="lucida 15 bold", padx=1).grid(row=2, column=3)
Label(root, text="Password\t \t -", font="lucida 15 bold").grid(row=3, column=3)
Label(root, text="E-mail address\t \t -", font="lucida 15 bold", padx=1).grid(row=4, column=3)
Label(root, text="Phone number\t \t -", font="lucida 15 bold", padx=1).grid(row=5, column=3)
